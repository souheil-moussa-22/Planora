    ...
    <div class="page-container">
      ...
      <div class="planora-card">
        ...
        @if (!loading) {
          ...
          @if (sprints.length > 0) {
            <table mat-table [dataSource]="sprints" class="planora-table">
              <ng-container matColumnDef="name">
                <th mat-header-cell *matHeaderCellDef>Name</th>
                <td mat-cell *matCellDef="let s">
                  <div class="sprint-name-cell">
                    @if (s.status === 1) {
                      <span class="active-dot" matTooltip="Active sprint"></span>
                    }
              ...
              <ng-container matColumnDef="actions">
                ...
                <td mat-cell *matCellDef="let s" class="actions-cell">
                  @if (canManage && s.status !== 2) {
                    <button mat-icon-button (click)="openEdit(s)" matTooltip="Edit">
                      <mat-icon>edit</mat-icon>
                    </button>
                  }
                  @if (canManage && s.status === 1) {
                    <button mat-icon-button (click)="closeSprint(s)" matTooltip="Close Sprint">
                      <mat-icon>lock_outline</mat-icon>
                    </button>
                  }
                  @if (canManage) {
                    <button mat-icon-button class="delete-btn" (click)="deleteSprint(s)" matTooltip="Delete">
